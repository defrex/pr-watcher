...
- Branch status vs. base (commits behind, merge conflicts appearing or resolving)
...
| `branch_status`  | branch is behind base or has merge conflicts (and on transitions back to clean) | `pr`, `base`, `behind`, `conflict`, `url` |
